...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "magpieweb" because\n';
  ...
  $wnd.__gwt_activeModules['magpieweb'] = {
    'moduleName' : 'magpieweb',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/magpieweb.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['magpieweb'].superdevmode = true;

  var expectedSuffix = '/magpieweb.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + magpieweb + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:magpieweb';
  var devModeSessionKey = '__gwtDevModeSession:magpieweb';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/magpieweb/magpieweb.nocache.js';
  ...
  $wnd.__gwt_activeModules['magpieweb'].canRedirect = true;
  $wnd.__gwt_activeModules['magpieweb'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/magpieweb?user.agent=' + ua + '&_callback=' + callback;
