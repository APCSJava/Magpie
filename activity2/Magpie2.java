...
/**
 ...
 public String getResponse(String statement)
 {
  ...
  if (statement.indexOf("no") >= 0){
   ...
   response = "Tell me more about what it's like out.";
        }else if (statement.indexOf("tv") >= 0 || statement.indexOf("TV") >= 0){
            response = "What types of TV shows do you like?";
        }else if (statement.indexOf("programming")>=0 || statement.indexOf("Programming")>=0){
