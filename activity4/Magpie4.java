 ...
 public String getResponse(String statement)
 {
    ...
    || findKeyword(statement, "brother") >= 0)
  {
   response = "Tell me more about your family.";
        ...
        {
            response = "What do you like about "+statement.substring(findKeyword(statement.toLowerCase(), "i like")+7, statement.length())+"?";
        }
else if (findKeyword(statement.toLowerCase(), "I want") >= 0)
{
    response = "Would you be really happy if you had "+statement.substring(findKeyword(statement.toLowerCase(), "i want")+7, statement.length())+"?";
}
